...
cat(int fd)
{
  ...
  47:	68 8e 09 00 00       	push   $0x98e
  4c:	6a 01                	push   $0x1
  4e:	e8 85 05 00 00       	call   5d8 <printf>
...
main(int argc, char *argv[])
{
  ...
  ce:	50                   	push   %eax
  cf:	68 9f 09 00 00       	push   $0x99f
  d4:	6a 01                	push   $0x1
  d6:	e8 fd 04 00 00       	call   5d8 <printf>
...
putc(int fd, char c)
{
 ...
 519:	e8 3b ff ff ff       	call   459 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 536:	74 17                	je     54f <printint+0x2b>
 538:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 53c:	79 11                	jns    54f <printint+0x2b>
    neg = 1;
 ...
 54d:	eb 06                	jmp    555 <printint+0x31>
  } else {
    x = xx;
 ...
 574:	0f b6 80 48 0c 00 00 	movzbl 0xc48(%eax),%eax
 ...
 593:	75 c7                	jne    55c <printint+0x38>
  if(neg)
 595:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 599:	74 2d                	je     5c8 <printint+0xa4>
    buf[i++] = '-';
 ...
 5a4:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 5a9:	eb 1d                	jmp    5c8 <printint+0xa4>
    putc(fd, buf[i]);
 ...
 5c0:	e8 3c ff ff ff       	call   501 <putc>
 ...
 5d0:	79 d9                	jns    5ab <printint+0x87>
    putc(fd, buf[i]);
}
 5d2:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 5f5:	e9 59 01 00 00       	jmp    753 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 614:	75 2c                	jne    642 <printf+0x6a>
      if(c == '%'){
 616:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 61a:	75 0c                	jne    628 <printf+0x50>
        state = '%';
 61c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 623:	e9 27 01 00 00       	jmp    74f <printf+0x177>
      } else {
        putc(fd, c);
 ...
 635:	e8 c7 fe ff ff       	call   501 <putc>
 63a:	83 c4 10             	add    $0x10,%esp
 63d:	e9 0d 01 00 00       	jmp    74f <printf+0x177>
      }
    } else if(state == '%'){
 642:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 646:	0f 85 03 01 00 00    	jne    74f <printf+0x177>
      if(c == 'd'){
 64c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 650:	75 1e                	jne    670 <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 65f:	e8 c0 fe ff ff       	call   524 <printint>
 664:	83 c4 10             	add    $0x10,%esp
        ap++;
 667:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 66b:	e9 d8 00 00 00       	jmp    748 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 670:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 674:	74 06                	je     67c <printf+0xa4>
 676:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 67a:	75 1e                	jne    69a <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 689:	e8 96 fe ff ff       	call   524 <printint>
 68e:	83 c4 10             	add    $0x10,%esp
        ap++;
 691:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 695:	e9 ae 00 00 00       	jmp    748 <printf+0x170>
      } else if(c == 's'){
 69a:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 69e:	75 43                	jne    6e3 <printf+0x10b>
        s = (char*)*ap;
 ...
 6b0:	75 25                	jne    6d7 <printf+0xff>
          s = "(null)";
 6b2:	c7 45 f4 b4 09 00 00 	movl   $0x9b4,-0xc(%ebp)
        while(*s != 0){
 6b9:	eb 1c                	jmp    6d7 <printf+0xff>
          putc(fd, *s);
 ...
 6cb:	e8 31 fe ff ff       	call   501 <putc>
 ...
 6df:	75 da                	jne    6bb <printf+0xe3>
 6e1:	eb 65                	jmp    748 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 6e3:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 6e7:	75 1d                	jne    706 <printf+0x12e>
        putc(fd, *ap);
 ...
 6f8:	e8 04 fe ff ff       	call   501 <putc>
 6fd:	83 c4 10             	add    $0x10,%esp
        ap++;
 700:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 704:	eb 42                	jmp    748 <printf+0x170>
      } else if(c == '%'){
 706:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 70a:	75 17                	jne    723 <printf+0x14b>
        putc(fd, c);
 ...
 719:	e8 e3 fd ff ff       	call   501 <putc>
 71e:	83 c4 10             	add    $0x10,%esp
 721:	eb 25                	jmp    748 <printf+0x170>
      } else {
 ...
 72b:	e8 d1 fd ff ff       	call   501 <putc>
 ...
 740:	e8 bc fd ff ff       	call   501 <putc>
 ...
 760:	0f 85 94 fe ff ff    	jne    5fa <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 778:	a1 68 0c 00 00       	mov    0xc68,%eax
...
free(void *ap)
{
 ...
 843:	a3 68 0c 00 00       	mov    %eax,0xc68
}
 848:	90                   	nop
 849:	c9                   	leave  
 84a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 86a:	50                   	push   %eax
 86b:	e8 51 fc ff ff       	call   4c1 <sbrk>
 ...
 8a1:	83 c4 10             	add    $0x10,%esp
  return freep;
 8a4:	a1 68 0c 00 00       	mov    0xc68,%eax
}
 8a9:	c9                   	leave  
 8aa:	c3                   	ret    
