...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f5:	0f b6 80 b8 0b 00 00 	movzbl 0xbb8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 631:	75 25                	jne    658 <printf+0xff>
          s = "(null)";
 633:	c7 45 f4 42 09 00 00 	movl   $0x942,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f9:	a1 d4 0b 00 00       	mov    0xbd4,%eax
...
free(void *ap)
{
 ...
 7c4:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 7c9:	90                   	nop
 7ca:	c9                   	leave  
 7cb:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 822:	83 c4 10             	add    $0x10,%esp
  return freep;
 825:	a1 d4 0b 00 00       	mov    0xbd4,%eax
}
 82a:	c9                   	leave  
 82b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 83e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 841:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 846:	89 45 f0             	mov    %eax,-0x10(%ebp)
 849:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 84d:	75 23                	jne    872 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 84f:	c7 45 f0 cc 0b 00 00 	movl   $0xbcc,-0x10(%ebp)
 856:	8b 45 f0             	mov    -0x10(%ebp),%eax
 859:	a3 d4 0b 00 00       	mov    %eax,0xbd4
 85e:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 863:	a3 cc 0b 00 00       	mov    %eax,0xbcc
    base.s.size = 0;
 868:	c7 05 d0 0b 00 00 00 	movl   $0x0,0xbd0
 86f:	00 00 00 
  }
 ...
 8c5:	a3 d4 0b 00 00       	mov    %eax,0xbd4
      return (void*)(p + 1);
 ...
 8d0:	eb 3b                	jmp    90d <malloc+0xe1>
    ...
    if(p == freep)
 8d2:	a1 d4 0b 00 00       	mov    0xbd4,%eax
