...
main(int argc, char **argv)
{
  ...
  1c:	68 f1 08 00 00       	push   $0x8f1
  21:	6a 02                	push   $0x2
  23:	e8 13 05 00 00       	call   53b <printf>
...
putc(int fd, char c)
{
 ...
 47c:	e8 3b ff ff ff       	call   3bc <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d7:	0f b6 80 78 0b 00 00 	movzbl 0xb78(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 613:	75 25                	jne    63a <printf+0xff>
          s = "(null)";
 615:	c7 45 f4 05 09 00 00 	movl   $0x905,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a6:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 7ab:	90                   	nop
 7ac:	c9                   	leave  
 7ad:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7cd:	50                   	push   %eax
 7ce:	e8 51 fc ff ff       	call   424 <sbrk>
...
malloc(uint nbytes)
{
 ...
 820:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 823:	a1 94 0b 00 00       	mov    0xb94,%eax
 828:	89 45 f0             	mov    %eax,-0x10(%ebp)
 82b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 82f:	75 23                	jne    854 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 831:	c7 45 f0 8c 0b 00 00 	movl   $0xb8c,-0x10(%ebp)
 838:	8b 45 f0             	mov    -0x10(%ebp),%eax
 83b:	a3 94 0b 00 00       	mov    %eax,0xb94
 840:	a1 94 0b 00 00       	mov    0xb94,%eax
 845:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    base.s.size = 0;
 84a:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 851:	00 00 00 
  }
 ...
 8a7:	a3 94 0b 00 00       	mov    %eax,0xb94
      return (void*)(p + 1);
 ...
 8b2:	eb 3b                	jmp    8ef <malloc+0xe1>
    ...
    if(p == freep)
 8b4:	a1 94 0b 00 00       	mov    0xb94,%eax
