...
main(int argc, char *argv[])
{
  ...
  1c:	68 0f 09 00 00       	push   $0x90f
  21:	6a 02                	push   $0x2
  23:	e8 31 05 00 00       	call   559 <printf>
  ...
  6e:	50                   	push   %eax
  6f:	68 23 09 00 00       	push   $0x923
  74:	6a 02                	push   $0x2
  76:	e8 de 04 00 00       	call   559 <printf>
...
putc(int fd, char c)
{
 ...
 48b:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 48e:	83 ec 04             	sub    $0x4,%esp
 491:	6a 01                	push   $0x1
 493:	8d 45 f4             	lea    -0xc(%ebp),%eax
 496:	50                   	push   %eax
 497:	ff 75 08             	pushl  0x8(%ebp)
 49a:	e8 3b ff ff ff       	call   3da <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b7:	74 17                	je     4d0 <printint+0x2b>
 4b9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 4bd:	79 11                	jns    4d0 <printint+0x2b>
    neg = 1;
 ...
 4ce:	eb 06                	jmp    4d6 <printint+0x31>
  } else {
    x = xx;
 ...
 4f5:	0f b6 80 b0 0b 00 00 	movzbl 0xbb0(%eax),%eax
 ...
 514:	75 c7                	jne    4dd <printint+0x38>
  if(neg)
 516:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 51a:	74 2d                	je     549 <printint+0xa4>
    buf[i++] = '-';
 ...
 525:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 52a:	eb 1d                	jmp    549 <printint+0xa4>
    putc(fd, buf[i]);
 ...
 541:	e8 3c ff ff ff       	call   482 <putc>
 ...
 551:	79 d9                	jns    52c <printint+0x87>
    putc(fd, buf[i]);
}
 553:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 576:	e9 59 01 00 00       	jmp    6d4 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 595:	75 2c                	jne    5c3 <printf+0x6a>
      if(c == '%'){
 597:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 59b:	75 0c                	jne    5a9 <printf+0x50>
        state = '%';
 59d:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 5a4:	e9 27 01 00 00       	jmp    6d0 <printf+0x177>
      } else {
        putc(fd, c);
 ...
 5b6:	e8 c7 fe ff ff       	call   482 <putc>
 5bb:	83 c4 10             	add    $0x10,%esp
 5be:	e9 0d 01 00 00       	jmp    6d0 <printf+0x177>
      }
    } else if(state == '%'){
 5c3:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 5c7:	0f 85 03 01 00 00    	jne    6d0 <printf+0x177>
      if(c == 'd'){
 5cd:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 5d1:	75 1e                	jne    5f1 <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 5e0:	e8 c0 fe ff ff       	call   4a5 <printint>
 5e5:	83 c4 10             	add    $0x10,%esp
        ap++;
 5e8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 5ec:	e9 d8 00 00 00       	jmp    6c9 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 5f1:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 5f5:	74 06                	je     5fd <printf+0xa4>
 5f7:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 5fb:	75 1e                	jne    61b <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 60a:	e8 96 fe ff ff       	call   4a5 <printint>
 60f:	83 c4 10             	add    $0x10,%esp
        ap++;
 612:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 616:	e9 ae 00 00 00       	jmp    6c9 <printf+0x170>
      } else if(c == 's'){
 61b:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 61f:	75 43                	jne    664 <printf+0x10b>
        s = (char*)*ap;
 ...
 631:	75 25                	jne    658 <printf+0xff>
          s = "(null)";
 633:	c7 45 f4 3c 09 00 00 	movl   $0x93c,-0xc(%ebp)
        while(*s != 0){
 63a:	eb 1c                	jmp    658 <printf+0xff>
          putc(fd, *s);
 ...
 64c:	e8 31 fe ff ff       	call   482 <putc>
 ...
 660:	75 da                	jne    63c <printf+0xe3>
 662:	eb 65                	jmp    6c9 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 664:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 668:	75 1d                	jne    687 <printf+0x12e>
        putc(fd, *ap);
 ...
 679:	e8 04 fe ff ff       	call   482 <putc>
 67e:	83 c4 10             	add    $0x10,%esp
        ap++;
 681:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 685:	eb 42                	jmp    6c9 <printf+0x170>
      } else if(c == '%'){
 687:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 68b:	75 17                	jne    6a4 <printf+0x14b>
        putc(fd, c);
 ...
 69a:	e8 e3 fd ff ff       	call   482 <putc>
 69f:	83 c4 10             	add    $0x10,%esp
 6a2:	eb 25                	jmp    6c9 <printf+0x170>
      } else {
 ...
 6ac:	e8 d1 fd ff ff       	call   482 <putc>
 ...
 6c1:	e8 bc fd ff ff       	call   482 <putc>
 ...
 6e1:	0f 85 94 fe ff ff    	jne    57b <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 6f9:	a1 cc 0b 00 00       	mov    0xbcc,%eax
...
free(void *ap)
{
 ...
 7c4:	a3 cc 0b 00 00       	mov    %eax,0xbcc
}
 7c9:	90                   	nop
 7ca:	c9                   	leave  
 7cb:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 81c:	50                   	push   %eax
 81d:	e8 c8 fe ff ff       	call   6ea <free>
 822:	83 c4 10             	add    $0x10,%esp
  return freep;
 825:	a1 cc 0b 00 00       	mov    0xbcc,%eax
}
 82a:	c9                   	leave  
 82b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 83e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 841:	a1 cc 0b 00 00       	mov    0xbcc,%eax
 846:	89 45 f0             	mov    %eax,-0x10(%ebp)
 849:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 84d:	75 23                	jne    872 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 84f:	c7 45 f0 c4 0b 00 00 	movl   $0xbc4,-0x10(%ebp)
 856:	8b 45 f0             	mov    -0x10(%ebp),%eax
 859:	a3 cc 0b 00 00       	mov    %eax,0xbcc
 85e:	a1 cc 0b 00 00       	mov    0xbcc,%eax
 863:	a3 c4 0b 00 00       	mov    %eax,0xbc4
    base.s.size = 0;
 868:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 86f:	00 00 00 
  }
 ...
 8c5:	a3 cc 0b 00 00       	mov    %eax,0xbcc
      return (void*)(p + 1);
 8ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8cd:	83 c0 08             	add    $0x8,%eax
 8d0:	eb 3b                	jmp    90d <malloc+0xe1>
    }
    if(p == freep)
 8d2:	a1 cc 0b 00 00       	mov    0xbcc,%eax
 8d7:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 8da:	75 1e                	jne    8fa <malloc+0xce>
      if((p = morecore(nunits)) == 0)
 8dc:	83 ec 0c             	sub    $0xc,%esp
 8df:	ff 75 ec             	pushl  -0x14(%ebp)
 8e2:	e8 e5 fe ff ff       	call   7cc <morecore>
 8e7:	83 c4 10             	add    $0x10,%esp
 8ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8ed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8f1:	75 07                	jne    8fa <malloc+0xce>
        return 0;
 8f3:	b8 00 00 00 00       	mov    $0x0,%eax
 8f8:	eb 13                	jmp    90d <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 908:	e9 6d ff ff ff       	jmp    87a <malloc+0x4e>
}
 90d:	c9                   	leave  
 90e:	c3                   	ret    
