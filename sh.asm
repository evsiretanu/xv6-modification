...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 2c 15 00 00 	mov    0x152c(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 00 15 00 00       	push   $0x1500
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      6b:	50                   	push   %eax
      6c:	68 07 15 00 00       	push   $0x1507
      71:	6a 02                	push   $0x2
      73:	e8 cf 10 00 00       	call   1147 <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      be:	50                   	push   %eax
      bf:	68 17 15 00 00       	push   $0x1517
      c4:	6a 02                	push   $0x2
      c6:	e8 7c 10 00 00       	call   1147 <printf>
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 27 15 00 00       	push   $0x1527
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 44 15 00 00       	push   $0x1544
     259:	6a 02                	push   $0x2
     25b:	e8 e7 0e 00 00       	call   1147 <printf>
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 47 15 00 00       	push   $0x1547
...
// add support for built-ins here. cd is a built-in
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2e9:	0f b6 05 c0 1a 00 00 	movzbl 0x1ac0,%eax
     2f0:	3c 63                	cmp    $0x63,%al
     2f2:	75 5f                	jne    353 <main+0xb3>
     2f4:	0f b6 05 c1 1a 00 00 	movzbl 0x1ac1,%eax
     2fb:	3c 64                	cmp    $0x64,%al
     2fd:	75 54                	jne    353 <main+0xb3>
     2ff:	0f b6 05 c2 1a 00 00 	movzbl 0x1ac2,%eax
     ...
     30d:	68 c0 1a 00 00       	push   $0x1ac0
     312:	e8 fc 09 00 00       	call   d13 <strlen>
     317:	83 c4 10             	add    $0x10,%esp
     31a:	83 e8 01             	sub    $0x1,%eax
     31d:	c6 80 c0 1a 00 00 00 	movb   $0x0,0x1ac0(%eax)
      if(chdir(buf+3) < 0)
     324:	b8 c3 1a 00 00       	mov    $0x1ac3,%eax
     ...
     339:	b8 c3 1a 00 00       	mov    $0x1ac3,%eax
     33e:	83 ec 04             	sub    $0x4,%esp
     341:	50                   	push   %eax
     342:	68 4f 15 00 00       	push   $0x154f
     347:	6a 02                	push   $0x2
     349:	e8 f9 0d 00 00       	call   1147 <printf>
    ...
    if(fork1() == 0)
     ...
     35f:	68 c0 1a 00 00       	push   $0x1ac0
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     380:	6a 64                	push   $0x64
     382:	68 c0 1a 00 00       	push   $0x1ac0
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 5d 15 00 00       	push   $0x155d
     3ad:	6a 02                	push   $0x2
     3af:	e8 93 0d 00 00       	call   1147 <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 61 15 00 00       	push   $0x1561
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 25 10 00 00       	call   141a <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 ef 0f 00 00       	call   141a <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 8c 0f 00 00       	call   141a <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 44 0f 00 00       	call   141a <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 fc 0e 00 00       	call   141a <malloc>
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 9c 1a 00 00       	push   $0x1a9c
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 9c 1a 00 00       	push   $0x1a9c
     ...
     63c:	50                   	push   %eax
     63d:	68 a4 1a 00 00       	push   $0x1aa4
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 9c 1a 00 00       	push   $0x1a9c
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 66 15 00 00       	push   $0x1566
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 67 15 00 00       	push   $0x1567
     772:	6a 02                	push   $0x2
     774:	e8 ce 09 00 00       	call   1147 <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 76 15 00 00       	push   $0x1576
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 7d 15 00 00       	push   $0x157d
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 7f 15 00 00       	push   $0x157f
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 81 15 00 00       	push   $0x1581
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 83 15 00 00       	push   $0x1583
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 a0 15 00 00       	push   $0x15a0
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 a3 15 00 00       	push   $0x15a3
    ...
    panic("parseblock");
     ...
     9c4:	68 a5 15 00 00       	push   $0x15a5
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 b0 15 00 00       	push   $0x15b0
    ...
    panic("syntax - missing )");
     ...
     a14:	68 b2 15 00 00       	push   $0x15b2
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 a3 15 00 00       	push   $0x15a3
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 76 15 00 00       	push   $0x1576
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 c5 15 00 00       	push   $0x15c5
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 d3 15 00 00       	push   $0x15d3
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 d8 15 00 00 	mov    0x15d8(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
    ...
    1073:	83 ec 18             	sub    $0x18,%esp
    1076:	8b 45 0c             	mov    0xc(%ebp),%eax
    1079:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    107c:	83 ec 04             	sub    $0x4,%esp
    107f:	6a 01                	push   $0x1
    1081:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1084:	50                   	push   %eax
    1085:	ff 75 08             	pushl  0x8(%ebp)
    1088:	e8 3b ff ff ff       	call   fc8 <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    10a1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    10a5:	74 17                	je     10be <printint+0x2b>
    10a7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    10ab:	79 11                	jns    10be <printint+0x2b>
    neg = 1;
    10ad:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    10b4:	8b 45 0c             	mov    0xc(%ebp),%eax
    10b7:	f7 d8                	neg    %eax
    10b9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10bc:	eb 06                	jmp    10c4 <printint+0x31>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    10cb:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    10ce:	8d 41 01             	lea    0x1(%ecx),%eax
    10d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10d4:	8b 5d 10             	mov    0x10(%ebp),%ebx
    10d7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10da:	ba 00 00 00 00       	mov    $0x0,%edx
    10df:	f7 f3                	div    %ebx
    10e1:	89 d0                	mov    %edx,%eax
    10e3:	0f b6 80 ac 1a 00 00 	movzbl 0x1aac(%eax),%eax
    10ea:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    10ee:	8b 5d 10             	mov    0x10(%ebp),%ebx
    10f1:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10f4:	ba 00 00 00 00       	mov    $0x0,%edx
    10f9:	f7 f3                	div    %ebx
    10fb:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10fe:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1102:	75 c7                	jne    10cb <printint+0x38>
  if(neg)
    1104:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1108:	74 2d                	je     1137 <printint+0xa4>
    buf[i++] = '-';
    110a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    110d:	8d 50 01             	lea    0x1(%eax),%edx
    1110:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1113:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    1118:	eb 1d                	jmp    1137 <printint+0xa4>
    putc(fd, buf[i]);
    111a:	8d 55 dc             	lea    -0x24(%ebp),%edx
    111d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1120:	01 d0                	add    %edx,%eax
    1122:	0f b6 00             	movzbl (%eax),%eax
    1125:	0f be c0             	movsbl %al,%eax
    1128:	83 ec 08             	sub    $0x8,%esp
    112b:	50                   	push   %eax
    112c:	ff 75 08             	pushl  0x8(%ebp)
    112f:	e8 3c ff ff ff       	call   1070 <putc>
  ...
  while(--i >= 0)
    1137:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    113b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    113f:	79 d9                	jns    111a <printint+0x87>
    putc(fd, buf[i]);
}
    1141:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
    ...
    114a:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    114d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1154:	8d 45 0c             	lea    0xc(%ebp),%eax
    1157:	83 c0 04             	add    $0x4,%eax
    115a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    115d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1164:	e9 59 01 00 00       	jmp    12c2 <printf+0x17b>
    c = fmt[i] & 0xff;
    ...
    1177:	25 ff 00 00 00       	and    $0xff,%eax
    117c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    117f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1183:	75 2c                	jne    11b1 <printf+0x6a>
      if(c == '%'){
    1185:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1189:	75 0c                	jne    1197 <printf+0x50>
        state = '%';
    118b:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1192:	e9 27 01 00 00       	jmp    12be <printf+0x177>
      } else {
        putc(fd, c);
    ...
    11a4:	e8 c7 fe ff ff       	call   1070 <putc>
    11a9:	83 c4 10             	add    $0x10,%esp
    11ac:	e9 0d 01 00 00       	jmp    12be <printf+0x177>
      }
    } else if(state == '%'){
    11b1:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    11b5:	0f 85 03 01 00 00    	jne    12be <printf+0x177>
      if(c == 'd'){
    11bb:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    11bf:	75 1e                	jne    11df <printf+0x98>
        printint(fd, *ap, 10, 1);
    ...
    11c8:	6a 0a                	push   $0xa
    11ca:	50                   	push   %eax
    11cb:	ff 75 08             	pushl  0x8(%ebp)
    11ce:	e8 c0 fe ff ff       	call   1093 <printint>
    11d3:	83 c4 10             	add    $0x10,%esp
        ap++;
    11d6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11da:	e9 d8 00 00 00       	jmp    12b7 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    11df:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    11e3:	74 06                	je     11eb <printf+0xa4>
    11e5:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11e9:	75 1e                	jne    1209 <printf+0xc2>
        printint(fd, *ap, 16, 0);
    11eb:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11ee:	8b 00                	mov    (%eax),%eax
    11f0:	6a 00                	push   $0x0
    11f2:	6a 10                	push   $0x10
    11f4:	50                   	push   %eax
    11f5:	ff 75 08             	pushl  0x8(%ebp)
    11f8:	e8 96 fe ff ff       	call   1093 <printint>
    11fd:	83 c4 10             	add    $0x10,%esp
        ap++;
    1200:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1204:	e9 ae 00 00 00       	jmp    12b7 <printf+0x170>
      } else if(c == 's'){
    1209:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    120d:	75 43                	jne    1252 <printf+0x10b>
        s = (char*)*ap;
    ...
    121f:	75 25                	jne    1246 <printf+0xff>
          s = "(null)";
    1221:	c7 45 f4 f0 15 00 00 	movl   $0x15f0,-0xc(%ebp)
        while(*s != 0){
    1228:	eb 1c                	jmp    1246 <printf+0xff>
          putc(fd, *s);
    122a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    122d:	0f b6 00             	movzbl (%eax),%eax
    1230:	0f be c0             	movsbl %al,%eax
    1233:	83 ec 08             	sub    $0x8,%esp
    1236:	50                   	push   %eax
    1237:	ff 75 08             	pushl  0x8(%ebp)
    123a:	e8 31 fe ff ff       	call   1070 <putc>
    123f:	83 c4 10             	add    $0x10,%esp
          s++;
    1242:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    124e:	75 da                	jne    122a <printf+0xe3>
    1250:	eb 65                	jmp    12b7 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1252:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1256:	75 1d                	jne    1275 <printf+0x12e>
        putc(fd, *ap);
    ...
    1263:	50                   	push   %eax
    1264:	ff 75 08             	pushl  0x8(%ebp)
    1267:	e8 04 fe ff ff       	call   1070 <putc>
    126c:	83 c4 10             	add    $0x10,%esp
        ap++;
    126f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1273:	eb 42                	jmp    12b7 <printf+0x170>
      } else if(c == '%'){
    1275:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1279:	75 17                	jne    1292 <printf+0x14b>
        putc(fd, c);
    ...
    1288:	e8 e3 fd ff ff       	call   1070 <putc>
    128d:	83 c4 10             	add    $0x10,%esp
    1290:	eb 25                	jmp    12b7 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1292:	83 ec 08             	sub    $0x8,%esp
    1295:	6a 25                	push   $0x25
    1297:	ff 75 08             	pushl  0x8(%ebp)
    129a:	e8 d1 fd ff ff       	call   1070 <putc>
    129f:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    12a2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    12a5:	0f be c0             	movsbl %al,%eax
    12a8:	83 ec 08             	sub    $0x8,%esp
    12ab:	50                   	push   %eax
    12ac:	ff 75 08             	pushl  0x8(%ebp)
    12af:	e8 bc fd ff ff       	call   1070 <putc>
    12b4:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    12b7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    12be:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    12c2:	8b 55 0c             	mov    0xc(%ebp),%edx
    12c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    12c8:	01 d0                	add    %edx,%eax
    12ca:	0f b6 00             	movzbl (%eax),%eax
    12cd:	84 c0                	test   %al,%al
    12cf:	0f 85 94 fe ff ff    	jne    1169 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    13c0:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13c7:	77 07                	ja     13d0 <morecore+0x16>
    nu = 4096;
    13c9:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13d0:	8b 45 08             	mov    0x8(%ebp),%eax
    13d3:	c1 e0 03             	shl    $0x3,%eax
    13d6:	83 ec 0c             	sub    $0xc,%esp
    13d9:	50                   	push   %eax
    13da:	e8 51 fc ff ff       	call   1030 <sbrk>
    13df:	83 c4 10             	add    $0x10,%esp
    13e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13e5:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13e9:	75 07                	jne    13f2 <morecore+0x38>
    return 0;
    13eb:	b8 00 00 00 00       	mov    $0x0,%eax
    13f0:	eb 26                	jmp    1418 <morecore+0x5e>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    1404:	83 c0 08             	add    $0x8,%eax
    1407:	83 ec 0c             	sub    $0xc,%esp
    140a:	50                   	push   %eax
    140b:	e8 c8 fe ff ff       	call   12d8 <free>
    1410:	83 c4 10             	add    $0x10,%esp
  return freep;
    1413:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
}
    1418:	c9                   	leave  
    1419:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1423:	83 c0 07             	add    $0x7,%eax
    1426:	c1 e8 03             	shr    $0x3,%eax
    1429:	83 c0 01             	add    $0x1,%eax
    142c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    142f:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1434:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1437:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    143b:	75 23                	jne    1460 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    143d:	c7 45 f0 24 1b 00 00 	movl   $0x1b24,-0x10(%ebp)
    1444:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1447:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    144c:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1451:	a3 24 1b 00 00       	mov    %eax,0x1b24
    base.s.size = 0;
    1456:	c7 05 28 1b 00 00 00 	movl   $0x0,0x1b28
    145d:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14a1:	c1 e0 03             	shl    $0x3,%eax
    14a4:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    14a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14aa:	8b 55 ec             	mov    -0x14(%ebp),%edx
    14ad:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    14b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14b3:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
      return (void*)(p + 1);
    14b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14bb:	83 c0 08             	add    $0x8,%eax
    14be:	eb 3b                	jmp    14fb <malloc+0xe1>
    }
    if(p == freep)
    14c0:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    14c5:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    14c8:	75 1e                	jne    14e8 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    14ca:	83 ec 0c             	sub    $0xc,%esp
    14cd:	ff 75 ec             	pushl  -0x14(%ebp)
    14d0:	e8 e5 fe ff ff       	call   13ba <morecore>
    14d5:	83 c4 10             	add    $0x10,%esp
    14d8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14db:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14df:	75 07                	jne    14e8 <malloc+0xce>
        return 0;
    14e1:	b8 00 00 00 00       	mov    $0x0,%eax
    14e6:	eb 13                	jmp    14fb <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14eb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    14f6:	e9 6d ff ff ff       	jmp    1468 <malloc+0x4e>
}
    14fb:	c9                   	leave  
    14fc:	c3                   	ret    
